...
// 				PlayerPosition.xz - transformAspect.worldPosition.xz); 
// 			// * steeringComponent.VelocityWeight + steeringAspect.DesiredVelocity);
// 			float  desiredSpeed    = motionAspect.Settings.RunSpeed;
//
//
...
// 			motionAspect.DesiredVelocity += motionAspect.AvoidanceVelocity;
//
// 			motionAspect.AvoidanceVelocity = float3.zero;
// 			
// 			
//
// 			motionAspect.Velocity = motionAspect.Velocity.MoveTowards(motionAspect.DesiredVelocity, 
// 				motionAspect.Settings.VelocityChange * DeltaTime);
//
//
