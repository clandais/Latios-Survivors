...
namespace Survivors.Play.Authoring
{
	public class AnimationClipAuthoring : MonoBehaviour
	{
		...
		[TemporaryBakingType] struct AnimationClipSmartBakeItem : ISmartBakeItem<AnimationClipAuthoring>
		{
		...
		class AnimationClipBaker : SmartBaker<AnimationClipAuthoring, AnimationClipSmartBakeItem>
		{
		}
	}
