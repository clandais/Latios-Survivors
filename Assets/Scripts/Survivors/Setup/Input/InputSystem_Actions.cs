...
//     version 1.13.1
//     from Assets/Input Assets/InputSystem_Actions.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input Assets/InputSystem_Actions.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Globals"",
            ""id"": ""b3f53e16-15bd-4f0f-b74b-08c53c898de6"",
            ""actions"": [
                {
                    ""name"": ""Escape"",
                    ""type"": ""Button"",
                    ""id"": ""abf29eda-5aaa-4909-8b3a-c62ed771f214"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""aefb4c55-075a-4f69-99ff-db02e1e9ce44"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Globals_Escape = m_Globals.FindAction("Escape", throwIfNotFound: true);
        }
        ...
        ~@InputSystem_Actions()
        {
            ...
            UnityEngine.Debug.Assert(!m_Globals.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Globals.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Globals_Escape;
        /// <summary>
        /// Provides access to input actions defined in input action map "Globals".
        /// </summary>
        public struct GlobalsActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public GlobalsActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "Globals/Escape".
            /// </summary>
            public InputAction @Escape => m_Wrapper.m_Globals_Escape;
            /// <summary>
            /// Provides access to the underlying input action map instance.
            /// </summary>
            ...
            public bool enabled => Get().enabled;
            /// <summary>
            /// Implicitly converts an <see ref="GlobalsActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="GlobalsActions.UnregisterCallbacks(IGlobalsActions)" />.
            /// </summary>
            /// <seealso cref="GlobalsActions.UnregisterCallbacks(IGlobalsActions)" />
            ...
            /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
            /// </remarks>
            /// <seealso cref="GlobalsActions.AddCallbacks(IGlobalsActions)" />
            /// <seealso cref="GlobalsActions.RemoveCallbacks(IGlobalsActions)" />
            /// <seealso cref="GlobalsActions.UnregisterCallbacks(IGlobalsActions)" />
        ...
        /// <summary>
        /// Provides a new <see cref="GlobalsActions" /> instance referencing this action map.
        /// </summary>
        ...
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Globals" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="GlobalsActions.AddCallbacks(IGlobalsActions)" />
        /// <seealso cref="GlobalsActions.RemoveCallbacks(IGlobalsActions)" />
